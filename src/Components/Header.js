...
const Header = () => {
    ...
    return (
        <header className={`navbar absolute top-0 left-0 z-50 w-full border-stroke bg-white duration-300 dark:border-stroke-dark dark:bg-black ${navClose ? 'navClose' : ''}`}>
            <div className="container relative max-w-[1400px]">
                <div className="flex item-center justify-between">
                    <div className="block py-4 lg:py-7">
                        <a href="index.html" className="block max-w-[145px] sm:max-w-[180px]">
                            <img className="block dark:hidden" src={logo1} alt="logo" />
                            <img className="hidden dark:block" src={Logo2} alt="logo" />
                        </a>
                    </div>
                    <button
                        onClick={toggleNav}
                        className={`navbarOpen absolute right-4 top-1/2 z-50 flex h-10 w-10 -translate-y-1/2 flex-col items-center justify-center space-y-[6px] font-bold lg:hidden ${navOpen ? 'navClose' : ''}`}
                    ...
                    <div className={`menu-wrapper relative ${navOpen ? 'visible' : 'hidden'} justify-between lg:flex`}>
                        <button
                            className={`navClose fixed top-10 right-10 z-[9999] flex h-10 w-10 flex-col items-center justify-center font-bold lg:hidden ${navOpen ? 'visible' : 'hidden'}`}
                            name="navClose"
                            aria-label="navClose"
                        >
                            <span className="block h-[2px] w-7 rotate-45 bg-black dark:bg-white"></span>
                        ...
                        <nav className="fixed top-0 left-0 z-[999] flex h-screen w-full items-center justify-center bg-white bg-opacity-95 text-center backdrop-blur-sm dark:bg-black dark:bg-opacity-95 lg:static lg:h-auto lg:w-max lg:bg-transparent lg:backdrop-blur-none lg:dark:bg-transparent">
                            <ul className="items-center space-y-3 lg:flex lg:space-x-8 lg:space-y-0 xl:space-x-10">
                                ...
                                <li class="submenu-item menu-item group relative">
                                    <a href="index.html" class="submenu-taggler inline-flex items-center text-base font-medium text-black hover:text-primary group-hover:text-primary dark:text-white dark:hover:text-primary lg:py-7 active">
                                        Pages
                                        <span class="pl-3">
                                    ...
                                    <ul class="submenu space-y-5 pt-5 duration-300 lg:invisible lg:absolute lg:top-[120%] lg:block lg:w-[250px] lg:rounded-lg lg:bg-white lg:px-8 lg:pb-5 lg:text-left lg:opacity-0 lg:shadow-card lg:group-hover:visible lg:group-hover:top-full lg:group-hover:opacity-100 dark:lg:border-transparent dark:lg:bg-slate-100 lg:dark:shadow-card-dark">
                                        <li>
                                            <a href="blog-grid.html" class="font-heading inline-flex items-center justify-center text-center text-base text-black hover:text-primary dark:text-white dark:hover:text-primary">
                                                Blog Grids
                                            </a>
                                        </li>
                                        <li>
                                            <a href="blog-details.html" class="font-heading inline-flex items-center justify-center text-center text-base text-black hover:text-primary dark:text-white dark:hover:text-primary">
                                                Blog Details
                                            </a>
                                        </li>
                                        <li>
                                            <a href="404.html" class="font-heading inline-flex items-center justify-center text-center text-base text-black hover:text-primary dark:text-white dark:hover:text-primary">
                                                404 Error
                                            </a>
                                        </li>
                                        <li>
                                            <a href="signin.html" class="font-heading inline-flex items-center justify-center text-center text-base text-black hover:text-primary dark:text-white dark:hover:text-primary">
                                                Sign In
                                            </a>
                                        </li>
                                        <li>
                                            <a href="signup.html" class="font-heading inline-flex items-center justify-center text-center text-base text-black hover:text-primary dark:text-white dark:hover:text-primary">
                                                Sign Up
                                            </a>
                                        </li>
                                    </ul>
                    ...
                    <div className="mr-[60px] flex items-center justify-end lg:mr-0">
                        <label for="themeSwitcher" className="inline-flex cursor-pointer items-center" aria-label="themeSwitcher" name="themeSwitcher">
                        ...
                        <a href="signin.html" class="hidden py-[10px] px-6 text-base font-medium text-black hover:text-primary dark:text-white dark:hover:text-primary sm:inline-block">
                            Sign In
                        </a>
                        <a href="signup.html" class=" mr-3   hidden rounded-md bg-black py-[10px] px-[30px] text-base font-medium text-white hover:bg-opacity-90 sm:inline-block">
                            Sign Up
                        </a>
                    </div>
                </div>
