    ...
    return (
        <section className="relative z-10 pt-[110px]">
            ...
            <div className='container max-w-[1390px]'>
                <div className="rounded-2xl bg-white  px-5 pt-14 pb-14 md:pb-1 lg:pt-14 lg:pb-5 xl:px-10">
                    <div className="-mx-4 flex flex-wrap justify-center">
                        <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                            <div className="wow fadeInUp group mx-auto mb-[60px] max-w-[310px] text-center">
                                <div className="mx-auto mb-8 flex h-[90px] w-[90px] items-center justify-center rounded-3xl bg-sky-500 text-primary duration-300 group-hover:bg-primary group-hover:text-white dark:bg-[#2A2E44] dark:text-white dark:group-hover:bg-primary">
