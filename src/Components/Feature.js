    ...
    return (
        <div className="md:px-14 px-4 py-16 max-w-screen-2xl mx-auto">
            ...
            <div className="mt-20 md:w-1/2 mx-auto text-center">
                <h2 className="mb-4 text-3xl font-bold text-black dark:text-white sm:text-4xl md:text-[44px] md:leading-tight">Developed with seamless opportunities</h2>
                <p className="text-base text-body">We make it easy for them to subscribe, buy again, try new products, and manage their account.</p>
            </div>
                                ...
                                <div className="mx-auto mb-8 flex h-[90px] w-[90px] items-center justify-center rounded-3xl text-sky-400 text-primary duration-300 group-hover:bg-primary group-hover:text-white dark:bg-[#2A2E44] dark:text-white dark:group-hover:bg-primary">
                                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_211_971)">
                                            <path d="M25.3333 37H8.66667C8.22464 37 7.80072 36.8244 7.48816 36.5118C7.17559 36.1993 7 35.7754 7 35.3333V18.6667H25.3333V37ZM37 15.3333H7V8.66667C7 8.22464 7.17559 7.80072 7.48816 7.48816C7.80072 7.17559 8.22464 7 8.66667 7H35.3333C35.7754 7 36.1993 7.17559 36.5118 7.48816C36.8244 7.80072 37 8.22464 37 8.66667V15.3333Z" fill="currentColor"></path>
                                            <path d="M28.6667 37V18.6667H37V35.3333C37 35.7754 36.8244 36.1993 36.5118 36.5118C36.1993 36.8244 35.7754 37 35.3333 37H28.6667Z" fill="currentColor"></path>
                                        </g>
                                        <defs>
