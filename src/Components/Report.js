...
export default function Report() {
    return (
        <div className="pt-[100px]">
            <div className="-mx-2 flex flex-wrap items-center justify-center text-start">
                <div className="w-full px-4 lg:w-1/2">
                    <div className="wow fadeInUp lg:max-w-[510px] pl-10">
                        ...
                        <a href="#" className="inline-block rounded-md bg-black py-[10px] px-8 text-base font-medium text-white hover:bg-opacity-90">
                            Know More
                        </a>
                    </div>
                    </div>
                    <div className="order-first w-full px-4 lg:order-last lg:w-1/2">
                        <div className="wow fadeInUp relative z-10 mx-auto mb-14 w-full max-w-[470px] pb-6  lg:mb-0">
                            <img src={About2} alt="about img" className="mx-auto max-w-full"/>
