...
import mobile from "../assets/cta-light.png"
export default function screen() {
    return (
        <section className="relative z-20 pt-[110px]">
            <div className="rounded-2xl bg-white px-10 pt-14 shadow-md dark:bg-dark dark:shadow-md-dark sm:px-20 lg:px-12 lg:pt-20 xl:px-20">
                <div className="-mx-4 flex flex-wrap">
                    <div className="w-full self-center px-4 lg:w-1/2">
                        <div className="wow fadeInUp mx-auto max-w-[530px] text-center lg:ml-0 lg:text-left">
                    ...
                    <div className="w-full px-4 lg:w-1/2">
                        <div className="wow fadeInUp relative z-10 mx-auto mt-20 max-w-[435px] lg:mt-0">
                            <img src={mobile} alt="cta image" className="mx-auto max-w-full"/>
                                <div className="absolute -top-5 left-0 right-0 -z-10 aspect-square w-full rounded-full bg-sky-400"></div>
