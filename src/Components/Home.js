...
import HomeImg from "../assets/hero-light.png";
export default function Home() {
    return (
        <section className="pt-[165px]">
            <div className="container lg:max-w-[1305px] lg:px-12">
                <div className="-mx-4 flex flex-wrap items-center text-start">
                    <div className="w-full px-4 lg:w-7/12">
                        <div class="wow fadeInUp mb-12 lg:mb-0 lg:max-w-[570px]">
                            <span class="mb-5 block text-lg font-medium leading-tight text-black dark:text-white sm:text-[22px] xl:text-[22px]">
                                Ready to Use The App CSS Web Template.
                            </span>
                            <h1 class="mb-6 text-3xl font-bold leading-tight text-black dark:text-white sm:text-[40px] md:text-[50px] lg:text-[42px] xl:text-[50px]">
                                Easy Making More
                                <span class="inline bg-gradient-1 bg-clip-text text-sky-400	mr-2 ml-2">
                                    App &amp; Software
                                </span>
                                Site.
                            </h1>
                            ...
                            <div class="flex flex-wrap items-center">
                                <a href="javascript:void(0)" class="mr-6 mb-6 inline-flex h-[60px] items-center rounded-lg bg-black py-[14px] px-[30px] text-white hover:bg-opacity-90 dark:bg-white dark:text-black dark:hover:bg-opacity-90">
                                ...
                                <a href="#" class="glightbox mb-6 inline-flex items-center py-4 text-black hover:text-primary dark:text-white dark:hover:text-primary">
                    ...
                    <div class="w-full px-4 lg:w-5/12">
                        <div class="wow fadeInUp relative z-10 mx-auto w-full max-w-[530px] pt-8 lg:mr-0">
                            <img src={HomeImg} alt="hero image" class="mx-auto max-w-full" />
