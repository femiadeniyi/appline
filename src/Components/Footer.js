...
export default function Footer() {
    return (
        <footer>
                        ...
                        <div class="w-full px-4 lg:w-4/12 xl:w-5/12">
                            <div class="wow fadeInUp mb-11 max-w-[320px]">
                                <a href="index.html" class="mb-8 inline-block">
                                    <img src={logo1} alt="logo" class="block max-w-full dark:hidden" />
                                    <img src={Logo2} alt="logo" class="hidden max-w-full dark:block" />
                                </a>
                        ...
                        <div class="w-full px-4 lg:w-8/12 xl:w-7/12">
                            <div class="-mx-4 flex flex-wrap">
                                <div class="w-full px-4 sm:w-1/2 md:w-2/12 lg:w-2/12">
                                    <div class="wow fadeInUp mb-11">
                                        <h3 class="mb-8 text-[22px] font-medium text-black dark:text-white">
                                            Home
                                        </h3>
                                        <ul class="space-y-[10px]">
                                            <li>
                                                <a href="#" class="inline-block text-base text-body hover:text-primary">
                                                    Product
                                                </a>
                                            </li>
                                            <li>
            ...
            <div class="wow fadeInUp bg-sky-600 py-7 dark:bg-black">
                    ...
                    <div class="-mx-3 flex flex-wrap">
                        ...
                        <div class="w-full px-3 md:w-1/2 lg:w-1/3">
                            <div class="mb-4 flex items-center justify-center space-x-5 md:mb-0 md:justify-start lg:justify-center">
                                <a href="#" class="text-white opacity-70 hover:opacity-100" name="social icon" aria-label="social icon">
