...
export default function Blog() {
    return (
        <section className="relative z-10 bg-[#F8FAFB] py-[110px] dark:bg-[#15182B]">
            <div className="container">
                <div className="wow fadeInUp mx-auto mb-14 max-w-[690px] text-center lg:mb-[70px]">
                ...
                <div className="-mx-4 flex flex-wrap justify-center md:-mx-7 lg:-mx-5 xl:-mx-[35px]">
                    <div className="w-full px-4 md:w-1/2 md:px-7 lg:w-1/3 lg:px-5 xl:px-[35px]">
                        <div className="wow fadeInUp mb-10 ml-4">
                            ...
                            <div className="mt-[30px]">
                                <h3>
                                    <a href="blog-details.html" className="mb-3 inline-block text-xl font-semibold text-black hover:text-primary dark:text-white dark:hover:text-primary sm:text-2xl lg:text-xl xl:text-2xl">
                    ...
                    <div className="w-full px-4 md:w-1/2 md:px-7 lg:w-1/3 lg:px-5 xl:px-[35px]">
                        <div className="wow fadeInUp mb-10">
                            <div className="relative overflow-hidden rounded">
                                <img src={blog2} alt="blog post" class="w-full object-cover object-center"/>
                                    <div className="absolute top-0 left-0 flex h-full w-full items-end bg-gradient-3 px-[18px] py-4">
                                        <div className="-mx-[10px] flex flex-wrap">
                                            <p className="mt-3 flex items-center px-[10px] text-base font-medium text-white">
                                                <span className="mr-2">
                    ...
                    <div className="w-full px-4 md:w-1/2 md:px-7 lg:w-1/3 lg:px-5 xl:px-[35px]">
                        <div className="wow fadeInUp mb-10">
                            <div className="relative overflow-hidden rounded">
                                <img src={blog3} alt="blog post" class="w-full object-cover object-center"/>
                                    <div className="absolute top-0 left-0 flex h-full w-full items-end bg-gradient-2 px-[18px] py-4">
                                        <div className="-mx-[10px] flex flex-wrap">
                                            <p className="mt-3 flex items-center px-[10px] text-base font-medium text-white">
                                                <span className="mr-2">
                                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="mt-[30px]">
                                <h3>
                                    <a href="blog-details.html" class="mb-3 inline-block text-xl font-semibold text-black hover:text-primary dark:text-white dark:hover:text-primary sm:text-2xl lg:text-xl xl:text-2xl">
